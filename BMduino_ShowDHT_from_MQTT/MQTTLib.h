...
String topic="/arduino/dht/#" ;         // 預設的 MQTT 主題，使用萬用字元 # 訂閱所有相關主題

// 主題格式模板
const char* PubTop = "/arduino/dht/%s" ;  // 發布主題格式，%s 將被 MAC 地址取代
const char* SubTop = "/arduino/dht/#" ;   // 訂閱主題格式，# 是萬用字元，匹配所有子主題
